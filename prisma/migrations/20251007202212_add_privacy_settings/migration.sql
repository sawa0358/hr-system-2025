...
INSERT INTO "new_employees" ("address", "birthDate", "createdAt", "department", "email", "employeeId", "employeeNumber", "employeeType", "id", "isInvisibleTop", "isSuspended", "joinDate", "myNumber", "name", "organization", "parentEmployeeId", "password", "phone", "phoneInternal", "phoneMobile", "position", "retirementDate", "role", "selfIntroduction", "showInOrgChart", "status", "team", "updatedAt", "url", "userId") SELECT "address", "birthDate", "createdAt", "department", "email", "employeeId", "employeeNumber", "employeeType", "id", "isInvisibleTop", "isSuspended", "joinDate", "myNumber", "name", "organization", "parentEmployeeId", "password", "phone", "phoneInternal", "phoneMobile", "position", "retirementDate", "role", "selfIntroduction", "showInOrgChart", "status", "team", "updatedAt", "url", "userId" FROM "employees";
