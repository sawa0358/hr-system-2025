        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">有給休暇設定</h1>
                <p className="text-sm text-muted-foreground">法改正や会社規定に応じて設定を変更できます</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Link href="/">
              ...
              <div className="overflow-x-auto">
                <div className="min-w-[900px]">
                  ...
                  <div className="grid gap-2 text-xs font-medium text-muted-foreground pb-2 border-b mb-2">
                    <div className="grid grid-cols-[100px_140px_140px_repeat(7,80px)_50px] gap-2 items-center">
                      <div>週勤務日数</div>
                      <div>年間勤務日数（最小）</div>
                      <div>年間勤務日数（最大）</div>
                  ...
                  {partTimeGrantTable.map((entry, index) => (
                    <div
                      key={index}
                      className="grid grid-cols-[100px_140px_140px_repeat(7,80px)_50px] gap-2 items-center mb-2"
                    >
                      <div className="flex items-center gap-1">
                        <Input
                          ...
                          onChange={(e) =>
                            updatePartTimeEntry(index, "weeklyDays", Number.parseInt(e.target.value) || 0)
                          }
